...
// Подключение к Render Internal Database
const pool = new Pool({
  ...
  password: process.env.DB_PASSWORD,  // Обязательный! пароль, который Render выдал
  ssl: { rejectUnauthorized: false }  // Render требует SSL даже для Internal DB
});
